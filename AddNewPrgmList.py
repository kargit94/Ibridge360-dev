...
class AddNewPrgrmlist(BaseFunc):
    ...
    PRGM_PATH_VALUE="//body/div[4]/div[3]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]"
    ...
    ICON='//input[@name="programStartDate"]'
    DATE_ELE='//div[@class="MuiPickersSlideTransition-transitionContainer MuiPickersCalendar-transitionContainer"]//p'
    ...
    def PP_img(self):
        return self.get_pp_img().send_keys('E:\ibridge360\Images\python.jpg')
    ...
    def PC_img(self):
        self.get_PC_img().send_keys('E:\ibridge360\Images\python.jpg')
        time.sleep(2)
    ...
    def PP(self,valuePP):
        self.get_pp_value().send_keys(valuePP)
        # for x in valuePP:
    ...
    def Service(self,Prov):
        ...
        time.sleep(2)
    def get_sd_icon(self):
        return WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, self.ICON)))
    def click_sdIcon(self,start_date):
        self.get_sd_icon().click()

    def get_date_ele(self):
        return WebDriverWait(self.driver, 10).until(EC.presence_of_all_elements_located((By.XPATH, self.DATE_ELE)))
    def date_ele(self):
        self.get_date_ele()

    def get_ok(self):
        return WebDriverWait(self.driver, 10).until(EC.presence_of_all_elements_located((By.XPATH,self.OK)))
    def ok(self):
        self.get_ok().click()
        time.sleep(2)
    ...
    # start_date="2-May-2023"
    # dates=start_date.split("-")
    # driver.find_element(By.XPATH,'//input[@name="programStartDate"]').click()
    # p=driver.find_elements(By.XPATH,'//div[@class="MuiPickersSlideTransition-transitionContainer MuiPickersCalendar-transitionContainer"]//p')
    # for ele in p:
    #     if ele.text==dates[0]:
    #         ele.click()
    # ok=driver.find_element(By.XPATH,'//button/span[text()="OK"]').click()