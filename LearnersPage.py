...
class learnerPage(BaseFunc):
    ...
    #Element locators:
    LEARNER_Nav_BTN="//div[@class='MuiListItemText-root']//child::span[text()='Learners']"
    SEARCH_LEARNER='//*[@id="root"]/div/div/div[2]/div/div/div/div[1]/div/div[3]/div/input'

    def get_learner_btn(self):
        # return self.driver.find_element(By.XPATH,self.LEARNER_BTN)
        return WebDriverWait(self.driver,10).until(EC.presence_of_element_located((By.XPATH,self.LEARNER_Nav_BTN)))
    ...
    def get_search_ele(self):
        ...
        return WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH,self.SEARCH_LEARNER)))
